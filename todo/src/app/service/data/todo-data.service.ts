...
import { Todo, TodoRequest } from 'src/app/list-todos/list-todos.component';
...
export class TodoDataService {
  ...
  updateTodo(username:string,id:number, todo:TodoRequest){
    return this.http.put(`${TODO_JPA_API_URL}/users/${username}/todos/${id}`
    ,todo);
  }

  createTodo(username:string, todo:TodoRequest){
